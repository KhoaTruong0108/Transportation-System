...
namespace TransportService
{
  public class TransportClient {
    public interface Iface {
      ...
      string ReloadTicketPrice(List<TPriceTicket> priceTickets);
      string ReloadTransportPrice(List<TPriceTransport> priceTranportes);
    ...
    public class Client : Iface {
      ...
      public void send_ReloadTicketPrice(List<TPriceTicket> priceTickets)
      {
      ...
      public void send_ReloadTransportPrice(List<TPriceTransport> priceTranportes)
      {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TConfiguration _elem43 = new TConfiguration();
                    _elem43 = new TConfiguration();
                    _elem43.Read(iprot);
                    Configurations.Add(_elem43);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Configurations != null && __isset.configurations) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TConfiguration _iter44 in Configurations)
            {
              _iter44.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TSaleTicketDate _elem47 = new TSaleTicketDate();
                    _elem47 = new TSaleTicketDate();
                    _elem47.Read(iprot);
                    SaleDates.Add(_elem47);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (SaleDates != null && __isset.saleDates) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TSaleTicketDate _iter48 in SaleDates)
            {
              _iter48.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    {
      private List<TPriceTicket> _priceTickets;

      public List<TPriceTicket> PriceTickets
      {
        get
        {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.List) {
                {
                  PriceTickets = new List<TPriceTicket>();
                  TList _list49 = iprot.ReadListBegin();
                  for( int _i50 = 0; _i50 < _list49.Count; ++_i50)
                  {
                    TPriceTicket _elem51 = new TPriceTicket();
                    _elem51 = new TPriceTicket();
                    _elem51.Read(iprot);
                    PriceTickets.Add(_elem51);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (PriceTickets != null && __isset.priceTickets) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TPriceTicket _iter52 in PriceTickets)
            {
              _iter52.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    {
      private List<TPriceTransport> _priceTranportes;

      public List<TPriceTransport> PriceTranportes
      {
        get
        {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.List) {
                {
                  PriceTranportes = new List<TPriceTransport>();
                  TList _list53 = iprot.ReadListBegin();
                  for( int _i54 = 0; _i54 < _list53.Count; ++_i54)
                  {
                    TPriceTransport _elem55 = new TPriceTransport();
                    _elem55 = new TPriceTransport();
                    _elem55.Read(iprot);
                    PriceTranportes.Add(_elem55);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (PriceTranportes != null && __isset.priceTranportes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TPriceTransport _iter56 in PriceTranportes)
            {
              _iter56.Write(oprot);
            }
            oprot.WriteListEnd();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Tickets != null && __isset.tickets) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TTicket _iter60 in Tickets)
            {
              _iter60.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TCustomer _elem63 = new TCustomer();
                    _elem63 = new TCustomer();
                    _elem63.Read(iprot);
                    Customers.Add(_elem63);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Customers != null && __isset.customers) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TCustomer _iter64 in Customers)
            {
              _iter64.Write(oprot);
            }
            oprot.WriteListEnd();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Ordres != null && __isset.ordres) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TOrder _iter71 in Ordres)
            {
              _iter71.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (OrderItems != null && __isset.orderItems) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TOrderItem _iter72 in OrderItems)
            {
              _iter72.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public partial class CreateTransportOrder_args : TBase
    {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TOrderItem _elem75 = new TOrderItem();
                    _elem75 = new TOrderItem();
                    _elem75.Read(iprot);
                    OrderItems.Add(_elem75);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (OrderItems != null && __isset.orderItems) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, OrderItems.Count));
            foreach (TOrderItem _iter76 in OrderItems)
            {
              _iter76.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public partial class UpdateOrderInfo_args : TBase
    {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TOrderItem _elem79 = new TOrderItem();
                    _elem79 = new TOrderItem();
                    _elem79.Read(iprot);
                    OrderItems.Add(_elem79);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (OrderItems != null && __isset.orderItems) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, OrderItems.Count));
            foreach (TOrderItem _iter80 in OrderItems)
            {
              _iter80.Write(oprot);
            }
            oprot.WriteListEnd();
