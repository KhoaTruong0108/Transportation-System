...
namespace Supervisor.Main
{
    public partial class Main : Form
    {
        ...
        /// <param name="e"></param>
        private void m_tsiSaleTicket_Click(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// Handles the Click event of the tsiGuaranteeFee control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void tsiGuaranteeFee_Click(object sender, EventArgs e)
        {
            GuaranteeFeeView frm = new GuaranteeFeeView();
            frm.ShowDialog();
        }
        /// <summary>
        /// Handles the Click event of the tsiSaleDate control.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            AutoSendMail.GetInstance().SendMail("Supervisor");
        }
    }
}
