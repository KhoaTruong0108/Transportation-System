              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TConfiguration _elem62 = new TConfiguration();
                    _elem62 = new TConfiguration();
                    _elem62.Read(iprot);
                    Configurations.Add(_elem62);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Configurations != null && __isset.configurations) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TConfiguration _iter63 in Configurations)
            {
              _iter63.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TSaleTicketDate _elem66 = new TSaleTicketDate();
                    _elem66 = new TSaleTicketDate();
                    _elem66.Read(iprot);
                    SaleDates.Add(_elem66);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (SaleDates != null && __isset.saleDates) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TSaleTicketDate _iter67 in SaleDates)
            {
              _iter67.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TTicketPrice _elem70 = new TTicketPrice();
                    _elem70 = new TTicketPrice();
                    _elem70.Read(iprot);
                    PriceTickets.Add(_elem70);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (PriceTickets != null && __isset.priceTickets) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TTicketPrice _iter71 in PriceTickets)
            {
              _iter71.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TTransportPrice _elem74 = new TTransportPrice();
                    _elem74 = new TTransportPrice();
                    _elem74.Read(iprot);
                    PriceTranportes.Add(_elem74);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (PriceTranportes != null && __isset.priceTranportes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TTransportPrice _iter75 in PriceTranportes)
            {
              _iter75.Write(oprot);
            }
            oprot.WriteListEnd();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Tickets != null && __isset.tickets) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TTicket _iter79 in Tickets)
            {
              _iter79.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TCustomer _elem82 = new TCustomer();
                    _elem82 = new TCustomer();
                    _elem82.Read(iprot);
                    Customers.Add(_elem82);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Customers != null && __isset.customers) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TCustomer _iter83 in Customers)
            {
              _iter83.Write(oprot);
            }
            oprot.WriteListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TOrderItem _elem89 = new TOrderItem();
                    _elem89 = new TOrderItem();
                    _elem89.Read(iprot);
                    OrderItems.Add(_elem89);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Ordres != null && __isset.ordres) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TOrder _iter90 in Ordres)
            {
              _iter90.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (OrderItems != null && __isset.orderItems) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TOrderItem _iter91 in OrderItems)
            {
              _iter91.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public partial class CreateTransportOrder_args : TBase
    {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TOrderItem _elem94 = new TOrderItem();
                    _elem94 = new TOrderItem();
                    _elem94.Read(iprot);
                    OrderItems.Add(_elem94);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (OrderItems != null && __isset.orderItems) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, OrderItems.Count));
            foreach (TOrderItem _iter95 in OrderItems)
            {
              _iter95.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public partial class UpdateOrderInfo_args : TBase
    {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TOrderItem _elem98 = new TOrderItem();
                    _elem98 = new TOrderItem();
                    _elem98.Read(iprot);
                    OrderItems.Add(_elem98);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (OrderItems != null && __isset.orderItems) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.Struct, OrderItems.Count));
            foreach (TOrderItem _iter99 in OrderItems)
            {
              _iter99.Write(oprot);
            }
            oprot.WriteListEnd();
